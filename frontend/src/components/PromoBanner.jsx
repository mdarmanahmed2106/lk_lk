...
const PromoBanner = ({ title, subtitle, buttonText, colorClass, image, link, className }) => {
  return (
    <motion.div
    ...
    >
      <div className="relative z-10 max-w-[60%]">
        ...
        <Link
          to={link || '/'}
          className="inline-flex bg-white text-lk-text px-4 py-2 rounded-lg text-sm font-semibold hover:bg-gray-100 transition-colors items-center gap-2 group"
        >
          {buttonText}
